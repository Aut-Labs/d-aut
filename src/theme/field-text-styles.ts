import { Breakpoint, ComponentsOverrides, ComponentsProps, ComponentsVariants, PaletteColor, TextField, Theme } from '@mui/material';
  ...
  ({
    ...
    styleOverrides: {
      root: ({ ownerState: { color } }) => {
        ...
        const styles = generateColors(theme.palette[colorVariant], theme.palette.offWhite);
